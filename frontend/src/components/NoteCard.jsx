...
const NoteCard = ({ note, setNotes }) => {
  ...
  return (
    ...
    >
      <div className="card-body bg-zinc-900 rounded-b-md">
        <h3 className="card-title text-base-content text-white">
          {note.title}
        </h3>
        <p className="text-base-content/70 line-clamp-3 text-zinc-300">
          {note.content}
        </p>
